...
ServiceModel _serviceModelDeserialize(
  ...
  object.iconCodePoint = reader.readLong(offsets[0]);
  object.id = id;
...
extension ServiceModelQueryFilter
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterFilterCondition> noteEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterFilterCondition> noteLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterFilterCondition> noteBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterFilterCondition> noteEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterFilterCondition> noteContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterFilterCondition> noteMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ServiceModelQuerySortBy
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterSortBy> sortByIconCodePoint() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterSortBy> sortByNote() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.asc);
    });
  }

  QueryBuilder<ServiceModel, ServiceModel, QAfterSortBy> sortByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ServiceModelQuerySortThenBy
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterSortBy> thenByIconCodePoint() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCodePoint', Sort.asc);
    });
  }
  ...
  QueryBuilder<ServiceModel, ServiceModel, QAfterSortBy> thenByNote() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.asc);
    });
  }

  QueryBuilder<ServiceModel, ServiceModel, QAfterSortBy> thenByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.desc);
    });
  }
...
extension ServiceModelQueryWhereDistinct
  ...
  QueryBuilder<ServiceModel, ServiceModel, QDistinct> distinctByNote({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ServiceModelQueryProperty
  ...
  QueryBuilder<ServiceModel, int, QQueryOperations> iconCodePointProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ServiceModel, String, QQueryOperations> noteProperty() {
    return QueryBuilder.apply(this, (query) {
